...
li.nav-item {
 ...
 .spanunderline {
    border-bottom: 3px solid #fbaa1e !important;
    width: 59px;
    padding-top: 10px;
p{
    font-size: 17px;
 ...
 <div class="tab-pane" id="verifications">
  ...
  if ($tfacode==false) {
    ...
    <div class="text-center" id="device">
      ...
      <lable class="marginTop50">Secret Key</lable>
   ...
   <p class="text-center" style="color:red;"> <?php if (isset($failcode)) {
      echo $failcode;
        ...
        <!-- <div class="tab-pane" id="notifications">
            <div class="text-center"><h3><u> NOTIFICATION</u></h3></div>

                <ul>
                    <li>
                        <div class="col-md-12">
                        <div class="col-md-9 text-center">OTP me into the Zenithnex Newsletter</div>
                        <label class="switch">
                        <input type="checkbox">
           ...
           <input class="btn btn-info text-center " type="submit" name="" value="UPDATE">
